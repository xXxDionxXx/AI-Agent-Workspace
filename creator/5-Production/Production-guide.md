...
### 🔄 การเกรดสีไฟล์ D-Log M ใน CapCut
ไฟล์ D-Log M จะมีลักษณะภาพจืดและแบน (Flat) เพื่อเก็บรายละเอียดแสงกว้างที่สุด ต้องนำมาแปลงสีและเกรดสีต่อดังนี้:
1. **นำไฟล์ LUT แปลงสี (Conversion LUT) มาใช้:**
   * นำเข้าไฟล์ **DJI Osmo Pocket 3 D-Log M to Rec.709 LUT** (ดาวน์โหลดได้จากเว็บทางการของ DJI)
   * ไปที่แท็บ **Adjust (ปรับแต่ง)** ➔ **LUT** ➔ **Import** ➔ เลือกไฟล์ LUT แปลงสี เพื่อแปลงภาพให้สีสันกลับมาสดใสมีมิติปกติเป็นด่านแรก
2. **ทับด้วย Brand LUT เพื่อสร้างมู้ดโทนพรีเมียม:**
   * สร้างเลเยอร์ปรับแต่ง (Adjustment Layer) หรือเลือกคลิปวิดีโอ ➔ ไปที่ **Adjust (ปรับแต่ง)** ➔ **LUT** ➔ นำเข้าไฟล์ LUT จากโฟลเดอร์ [creator/LUTS/](file:///c:/AI-Agent-Workspace/creator/LUTS/)
   * ปรับระดับความเข้มข้น (Strength/Opacity) ของ Brand LUT ให้อยู่ระหว่าง **35% - 50%** เพื่อความนุ่มนวลเป็นธรรมชาติ
3. **ปรับแต่งแก้ไขพื้นฐานด้วยเครื่องมือ CapCut (Basic Adjustment):**
   * **Contrast (ความเปรียบต่าง):** ดึงขึ้น `+5` เพื่อมิติภาพ
   * **Shadows (เงา):** ดึงลง `-5` เพื่อเน้นส่วนมืดให้ลึก
   * **HSL (สีผิวส้ม):** เลือกเมนู HSL ➔ คลิกสีส้ม ➔ ลด Saturation (ความอิ่มตัวสี) ลงเล็กน้อย `-8` เพื่อให้ผิวดูสว่างใสอมชมพู สกินโทนนวลพรีเมียมตามสไตล์ครีเอเตอร์ระดับโลก
